...
; schema-upgrade-notice.nsh is generated by scripts/write-schema-upgrade-notice.mjs: a real
; define when this build bumps CURRENT_SCHEMA_VERSION vs the last published release, and an
; empty stub otherwise (installer.nsh always includes it, so NSIS must not warn 7000 under -WX).
