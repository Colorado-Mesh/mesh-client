...
export function createDevElectronApiStub(): typeof window.electronAPI {
  ...
  return {
    ...
    onGattAdapterState: noopUnsub,
    onGattDeviceDiscovered: noopUnsub,
    onGattLinkRssi: noopUnsub,
    onGattConnected: noopUnsub,
    onGattDisconnected: noopUnsub,
    onGattConnectAborted: noopUnsub,
    onGattIssue: noopUnsub,
    onGattFromRadio: noopUnsub,
    startGattScanning: async () => ({ ok: true as const }),
    stopGattScanning: noopAsync,
    connectGatt: async () => ({ ok: true }),
    disconnectGatt: noopAsync,
    releaseGattBleCentral: noopAsync,
    clearGattBondRecoveryExclusive: noopAsync,
    isGattConnected: async () => false,
    gattToRadio: noopAsync,
    ...
    bleCoexistence: {
      ...
      suspendForReticulumBleConnect: async () => ({
        connections: [],
        scanOwner: null,
        nobleYieldDecisionPending: false,
      }),
    ...
    reticulum: {
      ...
      clearBleBondIssuesForOnlineInterfaces: async () => ({ running: false, port: 0, pid: null }),
      proxyGet: async () => ({}),
