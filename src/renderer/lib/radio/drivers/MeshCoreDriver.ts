...
import { MESHCORE_CAPABILITIES, type ProtocolCapabilities } from '../BaseRadioProvider';
import {
...
export class MeshCoreDriver implements RadioDriver {
  readonly protocol: MeshProtocol = 'meshcore';
