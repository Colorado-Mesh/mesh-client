...
| Method | Path                         | Body / notes           | Response                                                                                                                                                                  |
| ------ | ---------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | `/api/v1/peers`              |                        | `{ peers: [] }` — live path table when `rns-stack` enabled; `display_name` is overlayed from contacts/Nomad/announce label cache (announces still do not create contacts) |
