...
Severity 0–1 MECP alerts play a loud siren and emergency toast even when global or conversation mute is on. Severity 2–3 respect mutes. Drill codes (D01/D02) never alert. Configure Meshtastic↔MeshCore RF bridging under **App → MECP RF rebroadcast** (default off; optional bidirectional).
