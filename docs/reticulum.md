...
| Peers           | RNS path table + messaged History + saved Contacts + Favorites (Peers tab sub-tabs); LXMFace avatars; probe; **LXST Call** on rows; peer detail modal (Save as contact is manual)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
