...
- **Identity:** generate BIP-39 recovery phrase; import **private key** (hex / base64 / base32 or file picker via `reticulum:showIdentityImportDialog`); import/export PIN-encrypted Ratspeak **`.rsi`** (`ratspeak.identity.v2` via vendored Ratspeak vault); export/import official **raw 64-byte Reticulum identity** file (`export-raw`); display name; **replace identity** confirm when keys already exist (`replace: true` on generate/import)
