...
5. **Chat** → LXMF direct messages. **RRC** → multi-hub relay chat (rooms, nicklists, slash commands). **Peers** and **Topology** for path-table visibility. **Nomad Network** → browse announced nodes (Micron pages, back/forward, session cache) or open **My Pages** to host a static Nomad site.
...
| Propagation     | Preferred node, per-node **Sync messages**, rename/delete remote nodes, optional **local propagation inbox**, configurable **auto-sync interval**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
