...
| --------------------- | ---------------------------------------- | ----------------------- | ----------------------------------------- |
| @bufbuild/protobuf    | ^2.13.0                                  | Apache-2.0              | Protocol Buffers implementation           |
| @meshtastic/protobufs | npm:@jsr/meshtastic\_\_protobufs@^2.7.26 | Apache-2.0              | Meshtastic protocol definitions           |
| @stoprocent/noble     | ^2.5.9                                   | MIT                     | BLE (Bluetooth) interface                 |
| @zip.js/zip.js        | ^2.8.34                                  | BSD-3-Clause            | ZIP streaming and extraction              |
| builder-util-runtime  | 9.7.0                                    | MIT                     | Electron builder runtime utilities        |
| dompurify             | ^3.4.12                                  | MPL-2.0 OR Apache-2.0   | HTML sanitization                         |
...
| i18next               | ^26.3.6                                  | MIT                     | Internationalization framework            |
...
| @types/node                      | ^25.9.5                                            | MIT             | TypeScript types for Node.js     |
...
| @typescript-eslint/eslint-plugin | ^8.65.0                                            | MIT             | ESLint TypeScript plugin         |
| @typescript-eslint/parser        | ^8.65.0                                            | MIT             | ESLint TypeScript parser         |
| @vitejs/plugin-react             | ^6.0.4                                             | MIT             | Vite React plugin                |
| @vitest/coverage-v8              | ^4.1.10                                            | MIT             | Vitest V8 coverage               |
| concurrently                     | ^9.2.4                                             | MIT             | Run multiple commands            |
| electron                         | ^41.10.3                                           | MIT             | Desktop app framework            |
| electron-builder                 | ^26.15.7                                           | MIT             | Electron app packaging           |
| esbuild                          | ^0.28.1                                            | MIT             | Bundler                          |
| eslint                           | ^10.7.0                                            | MIT             | Linter                           |
...
| postcss                          | ^8.5.22                                            | MIT             | CSS processing                   |
...
| recharts                         | ^3.10.0                                            | MIT             | Charting library                 |
...
| typescript-eslint                | ^8.65.0                                            | MIT             | ESLint flat-config helper        |
| vite                             | ^8.1.5                                             | MIT             | Build tool                       |
| vitest                           | ^4.1.10                                            | MIT             | Testing framework                |
